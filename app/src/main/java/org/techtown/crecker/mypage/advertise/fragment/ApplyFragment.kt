...
class ApplyFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        UserAdServiceImpl.service.getUserAds(1).enqueue(object : Callback<UserAdData>{
            ...
            override fun onResponse(call: Call<UserAdData>, response: Response<UserAdData>) {
                ...
                adapter = MyAdAdapter(v.context, data as ArrayList<UserAdData.Data>, 1)

                v.rv_ad_apply_list.apply {
                    this.adapter = this@ApplyFragment.adapter
